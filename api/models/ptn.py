...
class PTN(BaseModel):
    ...
    def extract_audio(cls, _, values, **kwargs):
        filename = values.get('filename', '')
        audio_patterns = [
    ...
    def extract_hdr(cls, _, values, **kwargs):
        filename = values.get('filename', '')
        hdr_patterns = [
    ...
    def extract_codec(cls, _, values, **kwargs):
        filename = values.get('filename', '')
        codec_patterns = [
    ...
    def extract_bit_depth(cls, _, values, **kwargs):
        filename = values.get('filename', '')
        bit_depth_patterns = [
    ...
    def extract_edition(cls, _, values, **kwargs):
        filename = values.get('filename', '')
        edition_patterns = [
